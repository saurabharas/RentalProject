...
def wickedRideTmingStruc(pickUpDate,dropDate,pickUpTime,dropTime,weekdayInitialBaseCost,weekdayBaseRate,weekendBaseRate,weekdayFinalBase,weekendFinalBase,pickUpTotal,dropTotal):
