...
def internalDBWickedRide():
    ...
    dictWickedRide={'bangalore':
                       {'BAIYAPPANAHALLI METRO STATION':     {
                                           'ACTIVA':[500,229,5496,229,5496,2290,10]
                                           ,'NAVI':[500,133,2553,178,4272,1330,10]
                                           ,'PEP +':[500,51,976,69,1656,201,4]
                                           ,'LETS':[500,41,787,55,1200,164,4]
                                           ,'DIO':[500,41,787,55,1200,164,4]

                                           }
                        
                        ,'JAYANAGAR':{
                                            'VESPA':[500,229,5496,229,5496,2290,10]
                                           ,'LETS':[500,51,979,69,1656,204,4]
                                           ,'SR 150':[500,41,787,55,1200,164,4]
                                           ,'DIO':[500,41,787,55,1200,164,4]
                                          
                                            }
                        ,'ELECTRONIC CITY':{
                                            'LETS':[500,229,5496,229,5496,2290,10]
                                           }                                            }
                        ,'MYSORE ROAD-CHRIST COLLEGE':{
                                           'NAVI':[500,229,5496,229,5496,2290,10]
                                           ,'LETS':[500,133,2553,178,4272,1330,10]
                                           ,'SR 150':[500,41,787,55,1200,164,4]
                                           
                                            }
                        ,'ACHARYA COLLEGE':{
                                           'NAVI':[500,41,787,55,1200,164,4]
                                           ,'LETS':[500,41,787,55,1200,164,4]
