...
def internalDBWickedRide():
    ...
    dictWickedRide={'BANGALORE':
                       {'BAIYAPPANAHALLI METRO STATION':     {
                                           'ACTIVA':[500,30,400,35,450,150,5]
                                           ,'NAVI':[500,20,300,25,400,100,5]
                                           ,'PEP +':[500,15,250,20,300,75,5]
                                           ,'LETS':[500,25,350,30,400,125,5]
                                           ,'DIO':[500,20,350,30,400,125,5]

                                           }
                        
                        ,'JAYANAGAR':{
                                            'VESPA':[500,30,450,35,500,150,5]
                                           ,'LETS':[500,25,350,30,400,125,5]
                                           ,'SR 150':[500,30,500,35,650,150,5]
                                           ,'DIO':[500,20,350,30,400,125,5]
                        ...
                        ,'ART OF LIVING, KANAKAPURA MAIN ROAD':{
                                           'VESPA':[500,30,450,35,500,150,5]
                                           ,'LETS':[500,25,350,30,400,125,5]
                                           ,'PULSAR 150':[500,35,650,40,800,175,5]
                                           ,'SR 150':[500,30,500,35,650,150,5]
                                           ,'DIO':[500,20,350,30,400,125,5]
                                           ,'WEGO':[500,25,350,30,400,125,5]
                                           }
                        ...
                        ,'DON BOSCO IT COLLEGE, MYSORE ROAD':{
                                           'LETS':[500,25,350,30,400,125,5]
                        ...
                        ,'OYO FLAGSHIP -KORAMANGALA SONY SIGNAL':{
                                           'LETS':[500,25,350,30,400,125,5]
                        ...
                        ,'BETHESDA SCHOOL -KENGERI':{
                                            'PEP +':[500,15,250,20,300,75,5]
                                            }
                        
                    ,'MYSORE':{
                        'NAZARBAD':         {
                                           'ACTIVA':[500,20,250,25,350,80,4]
                                           ,'NAVI':[500,15,250,15,300,150,10]
                                           ,'LETS':[500,20,350,25,350,200,10]
                                           ,'PULSAR 150':[500,35,650,40,800,175,5]
                                           ,'DIO':[500,25,350,30,350,125,5]
                                           ,'AVENGER 150':[500,35,650,40,800,175,5]
                                           }
                    ,'INFOSYS GATE-4':{
                                           'ACTIVA':[500,20,250,25,350,80,4]
                                           ,'NAVI':[500,15,250,15,300,150,10]
                    ...
                    ,'JAIPUR':{
                        'JLN MARG':         {
                                           'ACTIVA':[500,30,500,35,500,150,5]
                                           ,'NAVI':[500,25,450,30,550,125,5]
                    ...
                    ,'UDAIPUR': {
                        'LAKE PALACE GATE':{
                                         'ACTIVA':[500,25,500,30,600,125,5]
                                         ,'LETS':[500,25,500,30,600,125,5]
                                         }
                        }
                    ,'BELAGAVI':{
                        'SHIVBASAV NAGAR':  {
                                        'NAVI':[500,20,300,25,350,100,5]
                                        ,'PEP +':[500,18,280,20,320,90,5]
                                        ,'LETS':[500,25,350,30,400,125,5]
                                        ,'SHINE':[500,30,450,35,550,150,5]
                                        }
                        }
                    ,'MANIPAL':   {
                        'HOTEL CENTRAL PARK':{
                    ...
                    ,'JAISALMER':  {
                        'JAISALMER FORT':{
                                        'ACTIVA':[500,45,1080,50,1200,540,12]
                                        ,'NAVI':[500,40,960,45,1080,480,12]
                                       }                                        
                        }
                    ,'GOKARNA':  {
                        'GOKARNA MAIN BEACH':{
                                        'NAVI':[500,40,800,45,900,480,12]
                                        ,'LETS':[500,25,350,30,400,125,5]
                                        ,'DIO':[500,40,800,45,900,480,12]
                                        }
                        }
                    ,'HOSPET':  {
                        'COWLPET':{
