...
cursor = conn.cursor()
cursor.execute('DROP TABLE IF EXISTS ROYALBROTHERS;')
    
cursor.execute('''CREATE TABLE ROYALBROTHERS
       (ID INT NOT NULL,
...
def pageNavigation(tr,tr2,td,td2,timeVal1,timeVal2,url):
    ...
    pickElementDate = browser1.find_element_by_xpath(".//*[@id='pickup-date-desk']").click()
    pickDate = browser1.find_element_by_xpath(".//*[@id='pickup-date-desk_table']/tbody/tr["+str(tr)+"]/td["+str(td)+"]/div").click()
    pickElementTime = browser1.find_element_by_xpath(".//*[@id='pickup-time-desk']").click()

    pickTime = browser1.find_element_by_xpath(".//*[@id='pickup-time-desk_root']/div/div/div/div/ul/li["+str(timeVal1)+"]").click()



    pickElementDate = browser1.find_element_by_xpath(".//*[@id='dropoff-date-desk']").click()
    pickDate = browser1.find_element_by_xpath(".//*[@id='dropoff-date-desk_table']/tbody/tr["+str(tr2)+"]/td["+str(td2)+"]/div").click()
    pickElementTime = browser1.find_element_by_xpath(".//*[@id='dropoff-time-desk']").click()
    pickTime = browser1.find_element_by_xpath(".//*[@id='dropoff-time-desk_root']/div/div/div/div/ul/li["+str(timeVal2)+"]").click()


    Search = browser1.find_element_by_xpath("html/body/main/div[3]/div/div[1]/div/form/div[5]/button").click()
    Location(url)
...
def Location(url):
    ...
    if url=="https://www.royalbrothers.in/bangalore":
        ...
        array = [21,8,11,20,1,18,19,22,9]

        i=0
        print array[i]
        selectLocation = browser1.find_element_by_xpath(".//*[@id='pinit']/form/div[5]/div/input").click()
        time.sleep(5)
        pickLocation1 = browser1.find_element_by_xpath(".//*[@value="+str(array[i])+"]").click()
        searchButton =   browser1.find_element_by_xpath(".//*[@id='pickup-date-desk_root']/div/div/div/div/div[2]/button[1]").click()
        page_info()
        i+=1
...
Location9= "https://www.royalbrothers.in/hyderabad"
dateNavigation(Location10)
Location9= "https://www.royalbrothers.in/pondicherry"
dateNavigation(Location11)
Location9= "https://www.royalbrothers.in/trivandrum"
dateNavigation(Location12)
